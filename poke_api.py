...
def search_pokemon(search_term):
    ...
    Returns:
        dict: A dictionary information about the pokemon
    """
    
    # Cleans the search term and prints live synopsis
    search_term = str(search_term).strip().lower()
    print(f'Retrieving information for {search_term.title()if search_term.isalpha() else "pokedex #"+search_term}...', end=' ')
